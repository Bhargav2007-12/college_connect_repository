...
RUN <<EOF
set -e
BASE_LIB_VERSION=v0.11.1
BASE_LIB_INSTALL_DIR="$HOME/.motoko/base/$BASE_LIB_VERSION"
mkdir -p "$BASE_LIB_INSTALL_DIR"
BASE_LIB_URL="https://github.com/dfinity/motoko-base/archive/refs/tags/moc-${BASE_LIB_VERSION}.tar.gz"
...
ENV MOTOKO_BASE="/home/ubuntu/.motoko/base/v0.11.1"
